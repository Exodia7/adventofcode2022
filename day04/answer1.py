...
with open(FILE_NAME, 'r') as f:
    ...
    for line in lines:
        ...
        # check whether one of the two contains the other
    ...
    print(f"There are {totalFullDuplicates} of assignment pairs where one range fully contains the other one.")
    # WRONG ! 535 is too high