...
# computes the total size of the file system, with a certain filter
def get_total_size(d : Directory, filter_func = (lambda x: True)):
	total_size = 0
	for child in d.children:
		curr_size = child.get_size()
		if filter_func(curr_size):
...
with open(FILE_NAME, 'r') as f:
    ...
    print(f"The total sum of the sizes of directories and files of size smaller than {MAX_SIZE} is {result}")
